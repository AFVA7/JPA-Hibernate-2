...
public class PruebaDeParametros {
	public static void main(String[] args) {
		...
		List<Producto> resultado = productoDao.consultarPorParametros("FIFA", new BigDecimal(10000), fechaEjemplo);
	...
	private static void cargarBancoDeDatos() {
		...
		Producto videoJuego = new Producto("FIFA", "fifa 2000", new BigDecimal(10000), videoJuegos);
